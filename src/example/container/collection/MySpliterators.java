...
public final class MySpliterators {

    // Suppresses default constructor, ensuring non-instantiability.
    private MySpliterators() {}
   ...
   public static Spliterator.OfDouble spliterator(double[] array, int fromIndex, int toIndex,
    ...
    public static <T> Spliterator<T> spliterator(MyCollection<? extends T> c,
                                                 int characteristics) {
    ...
    public static <T> Spliterator<T> spliterator(Iterable<? extends T> iterator,
                                                 long size,
                                                 int characteristics) {
        return new IteratorSpliterator<T>((Iterator<? extends T>) Objects.requireNonNull(iterator), size,
                characteristics);
    }

   public static <T> Spliterator<T> spliteratorUnknownSize(Iterable<? extends T> iterator,
                                                            int characteristics) {
        return new IteratorSpliterator<T>((MyCollection<? extends T>) Objects.requireNonNull(iterator), characteristics);
    }
   ...
   public static abstract class AbstractLongSpliterator implements Spliterator.OfLong {
    ...
    static class IteratorSpliterator<T> implements Spliterator<T> {
        static final int BATCH_UNIT = 1 << 10;  // batch array size increment
        static final int MAX_BATCH = 1 << 25;  // max batch array size;
        private final MyCollection<? extends T> collection; // null OK
        private Iterator<? extends T> it;
        private final int characteristics;
        private long est;             // size estimate
        private int batch;            // batch size for splits

        public IteratorSpliterator(MyCollection<? extends T> collection, int characteristics) {
