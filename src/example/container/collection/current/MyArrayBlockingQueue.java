...
import example.container.collection.MySpliterators;
...
public class MyArrayBlockingQueue<E> extends MyAbstractQueue<E>
    ...
    public Iterator<E> iterator() {
        return new MyArrayBlockingQueue.Itr();
    }
    ...
    class Itrs {
        ...
        private class Node extends WeakReference<MyArrayBlockingQueue.Itr> {
            MyArrayBlockingQueue.Itrs.Node next;

            Node(MyArrayBlockingQueue.Itr iterator, MyArrayBlockingQueue.Itrs.Node next) {
                super(iterator);
                this.next = next;
            }
        }
        ...
        private MyArrayBlockingQueue.Itrs.Node head;

        private MyArrayBlockingQueue.Itrs.Node sweeper = null;
        ...
        void register(MyArrayBlockingQueue.Itr itr) {
            // assert lock.getHoldCount() == 1;
        ...
        Itr() {
            ...
            try {
                if (count == 0) {
                    ...
                    if (itrs == null) {
                        itrs = new MyArrayBlockingQueue.Itrs(this);
                    } else {
    ...
    public Spliterator<E> spliterator() {
        return MySpliterators.spliterator
